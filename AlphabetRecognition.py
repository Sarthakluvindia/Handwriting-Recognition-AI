...
def enterval():
    ...
    dft = df.T
    dft.to_csv("datasets/HandwritingRecognition_MNIST_dataset.csv",header=False,mode="a",index=False)

# Instantiate a new GUI Window
window = tkinter.Tk()
window.title("Alphabet Recongnition")
window.geometry("350x300")
window.configure(background = "#ffffff")

#Defines GUI Elements
lbl = tkinter.Label(window, text="Alphabet Recognition", fg="#383a39", bg="#ffffff", font=("Helvetica", 23))
